                    ...
                    <div class="menu">
                        <div class="brand-logo">
                            <a href="https://themes.pixelstrap.com/sheltos/index.html">
                                <img src="https://themes.pixelstrap.com/sheltos/assets/images/logo/2.png" alt="" class="img-fluid"/>
                            </a>
                        </div>
                        <nav>
                                    ...
                                    <ul class="nav-menu">
                                            ...
                                            <ul class="nav-submenu menu-content">
                                                <li>
                                                    ...
                                                    <ul class="nav-sub-childmenu level1">
                                                        <li>
                                                            <a href="javascript:void(0)" class="submenu-title">2 Grid</a>
                                                        ...
                                                        <li>
                                                            <a href="javascript:void(0)" class="submenu-title">3 Grid</a>
                                                            <ul class="nav-sub-childmenu submenu-content level2">
                                                        ...
                                                        <li>
                                                            <a href="javascript:void(0)" class="submenu-title">map</a>
                                                            <ul class="nav-sub-childmenu submenu-content level2">
                                                        ...
                                                        <li>
                                                            <a href="javascript:void(0)" class="submenu-title">map modal</a>
                                                            <ul class="nav-sub-childmenu submenu-content level2">
                                                        ...
                                                        <li>
                                                            <a href="javascript:void(0)" class="submenu-title">Left side map</a>
                                                            <ul class="nav-sub-childmenu submenu-content level2">
                                                        ...
                                                        <li>
                                                            <a href="javascript:void(0)" class="submenu-title">onclick map</a>
                                                            <ul class="nav-sub-childmenu submenu-content level2">
                                                        ...
                                                        <li>
                                                            <a href="javascript:void(0)" class="submenu-title">map header</a>
                                                            <ul class="nav-sub-childmenu submenu-content level2">
                                                ...
                                                <li>
                                                    <a href="javascript:void(0)" class="menu-title-level1">List view</a>
                                                    <ul class="nav-sub-childmenu level1">
                                                        <li>
                                                            <a href="javascript:void(0)" class="submenu-title">Listing</a>
                                                            <ul class="nav-sub-childmenu submenu-content level2">
                                                ...
                                                <li>
                                                    <a href="javascript:void(0)" class="menu-title-level1">Tab layout</a>
                                                    <ul class="nav-sub-childmenu level1">
                                                    ...
                                                    <div class="row">
                                                                ...
                                                                <div class="submenu-content opensubmegamenu">
                                                                    <ul class="list">
                                                                        ...
                                                                        <li><a href="portfolio-creative-3.html">creative
                                                                                3 <span class="icon-trend label"><i class="fas fa-bolt"></i></span></a></li>
                                                                ...
                                                                <div class="submenu-content opensubmegamenu">
                                                                    <ul class="list">
                                                                        ...
                                                                        <li><a href="breadcrumb-with-effect.html">image
                                                                                with effect <span class="label">New</span></a></li>
                                                        ...
                                                        <div class="col mega-box">
                                                            ...
                                                            <div class="link-section">
                                                                ...
                                                                <div class="submenu-content opensubmegamenu">
                                                                    <ul class="list">
                                                                        <li><a href="user-dashboard.html">user dashboard <span class="icon-trend label"><i class="fas fa-bolt"></i></span></a></li>
                                                            ...
                                                            <div class="link-section">
                                                                ...
                                                                <div class="submenu-content opensubmegamenu">
                                                                    <ul class="list">
                                                                        ...
                                                                        <li><a href="signup-wizard.html">sign up wizard <span class="icon-trend label"><i class="fas fa-bolt"></i></span></a></li>
                                        ...
                                        <li class="dropdown">
                                            ...
                                            <ul class="nav-submenu menu-content">
                                                ...
                                                <li><a href="image-ratio-element.html">Image ratio <span class="icon-trend label"><i class="fas fa-bolt"></i></span></a>
                                                </li>
                                ...
                                <ul class="nav-menu">
                                    ...
                                    <li class="dropdown cart">
                                        ...
                                        <ul class="nav-submenu">
                                            <li>
                                                <div class="media">
                                                    <img src="https://themes.pixelstrap.com/sheltos/assets/images/property/2.jpg" class="img-fluid" alt=""/>
        ...
        <div class="container">
            <div class="row ratio_55">
                <div class="col-xl-3 col-lg-4">
                    <div class="left-sidebar single-sidebar left-tablayout">
                            ...
                            <div class="advance-card">
                                ...
                                <div class="recent-property">
                                    <ul>
                                        <li>
                                            <div class="media">
                                                <img src="https://themes.pixelstrap.com/sheltos/assets/images/property/9.jpg" class="img-fluid" alt=""/>
                                                <div class="media-body">
                                                    <h5>Sea Breezes</h5>
                                        ...
                                        <li>
                                            <div class="media">
                                                <img src="https://themes.pixelstrap.com/sheltos/assets/images/property/10.jpg" class="img-fluid" alt=""/>
                                                <div class="media-body">
                                                    <h5>Orchard House</h5>
                ...
                <div class="col-xl-9 col-lg-8 property-grid-2">
                    <div class="filter-panel tab-top-panel">
                        <div class="top-panel">
                            <div class="filters respon-filter-content filter-button-group">
                                <ul>
                                    <li class="active" data-filter="*"><span>All Property</span></li>
                                    <li data-filter=".sale"><span>For Sale</span></li>
                                    <li data-filter=".rent"><span>For rent</span></li>
                                </ul>
                            </div>
                    ...
                    <div class="property-2 row column-sm zoom-gallery property-label property-grid grid">
                        <div class="col-md-6 sale grid-item wow fadeInUp" data-class="sale">
                            <div class="property-box">
                                <div class="property-image">
                                    <img src="https://themes.pixelstrap.com/sheltos/assets/images/property/11.jpg" class="bg-img" alt=""   width="500px" height="400px"/>
                        ...
                        <div class="col-md-6 rent grid-item wow fadeInUp" data-class="rent">
                            <div class="property-box">
                                <div class="property-image">
                                    <img src="https://themes.pixelstrap.com/sheltos/assets/images/property/10.jpg" class="bg-img" alt=""  width="500px" height="400px"/>
                                    <div class="labels-left">
                                        <div>
                                            <span class="label label-shadow">sale</span>
                                        </div>
                        ...
                        <div class="col-md-6 sale grid-item wow fadeInUp" data-class="sale">
                            <div class="property-box">
                                <div class="property-image">
                                    <img src="https://themes.pixelstrap.com/sheltos/assets/images/property/14.jpg" class="bg-img" alt=""  width="500px" height="400px"/>
                                    <div class="labels-left">
                                        <div>
                        ...
                        <div class="col-md-6 rent grid-item wow fadeInUp" data-class="rent">
                            <div class="property-box">
                                <div class="property-image">
                                    <img src="https://themes.pixelstrap.com/sheltos/assets/images/property/15.jpg" class="bg-img" alt=""  width="500px" height="400px"/>
                                    <div class="labels-left">
                                        <div>
                                            <span class="label label-shadow">sale</span>
                                        </div>
                        ...
                        <div class="col-md-6 sale grid-item wow fadeInUp" data-class="sale">
                            <div class="property-box">
                                <div class="property-image">
                                    <img src="https://themes.pixelstrap.com/sheltos/assets/images/property/12.jpg" class="bg-img" alt="" width="500px" height="400px" />
                                    <div class="labels-left">
                                        <div>
                                            <span class="label label-shadow">sale</span>
                                        </div>
                        ...
                        <div class="col-md-6 rent grid-item wow fadeInUp" data-class="rent">
                            <div class="property-box">
                                <div class="property-image">
                                    <img src="https://themes.pixelstrap.com/sheltos/assets/images/property/16.jpg" class="bg-img" alt="" width="500px" height="400px"/>
                                    <div class="labels-left">
                                        <div>
                                            <span class="label label-dark">no fees</span>
                                        </div>
