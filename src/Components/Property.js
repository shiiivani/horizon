                        ...
                        <div className="col-md-6 col-xl-8">
                          <ul className="property-list-details">
                            <li>
                              ...
                              {investmentList.investmentAmount}
                            </li>
                            <li>
                              <span>Investment Percentage : </span>{" "}
                              {investmentList.investmentPercentage}%
                            </li>
                            <li>
                              <span>Investment Date : </span>
                              {investmentList.investmentDate}
                            </li>
                            <li>
                              <span>Investment Duration : </span>{" "}
                              {investmentList.investmentDuration}years
                            </li>
                          </ul>
                        </div>
                      </div>
